...
class Constants {
  ...
  static let FILTER_ICON = "line.3.horizontal.decrease.circle"
  static let FILTER_TAPPED_ICON = "line.3.horizontal.decrease.circle.filled"
  static let HEART_ICON = "heart"
  static let HEART_FILLED_ICON = "heart.filled"
  ...
  static let CAIRO_TIMEZONE = "Africa/Cairo"
  static let HM_DATE_FORMAT = "HH:mm"
  static let YMD_DATE_FORMAT = "YYYY-MM-dd"
}
